...
public class WordDictionary2 {
    private static WordDictionary2 singleton;
    private static final String MAIN_DICT = "/home/opensearchpr/E_search/data/dic/dict.txt";
    ...
    private DictSegment2 _dict;


    private WordDictionary2() {
        this.loadDict();
    }


    public static WordDictionary2 getInstance() {
        if (singleton == null) {
            synchronized (WordDictionary2.class) {
                if (singleton == null) {
                    singleton = new WordDictionary2();
                    return singleton;
                }
            }
        }
